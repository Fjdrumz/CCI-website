...
import MovingImages from "../TestSlide/TestSlide";
import "./VisitCci.css";
  ...
  return (
    <section className="VisitCCiSection">
      ...
      <section className="weBoastInChrist">
        <h2 className="weBoastInChristTitle">
        ...
        <p className="weBoastInChristText">
          ...
          to <br /> effectively evangelize, make disciples of, and deploy people
          who once upon a <br /> time were mere seekers, as mature disciples and
          vibrant ministers of the gospel.
        </p>
