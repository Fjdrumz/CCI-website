...
import { FiPlay, FiDownload, FiShare2, FiBookmark } from "react-icons/fi";
import SearchWithIcons from "../components/SearchSermons";
import HorizontalTag from "../components/SearchTags";
import PhotoCards from "../components/SermonsCard";
...
const LatestSermons = () => {
  ...
  const handlePlay = (sermon) => {
    ...
    console.log(`Playing: ${sermon.title}`);
  };
